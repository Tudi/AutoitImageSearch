...
char* WINAPI ImageSearch_SAD_Region(const char* aImageFile, int aLeft, int aTop, int aRight, int aBottom, enum SADSearchRegionFlags uSearchFlags); // when we want to search only a subreagion. Used for IsImageAt
